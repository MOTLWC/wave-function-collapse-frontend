...
function PromptCreatePage(props) {
    ...
    const handleSubmit = async () => {
        try {
            ...
            await getImageData()
            const userResponse = await promptService.create(formData)
        } catch (error) {
            alert("Something Went Wrong!")
        }
    }

    const {promptName} = formData
            ...
            <main>
                <div id="controlePannel">
                    ...
                    <div id="promptSaving">
                        ...
                        <button disabled={CheckSubmit()} onClick={handleSubmit}>Save</button>
                    </div>
                    :
                    <></>
                    }
